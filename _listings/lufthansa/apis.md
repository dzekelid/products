...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/lufthansa/apis.md
...
- name: LH Public - Retrieve all flights
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/lufthansa/cargogetrouteorigindestinationfromdateproductcode-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/lufthansa/cargogetrouteorigindestinationfromdateproductcode-get-openapi.md
- name: LH Public - Retrieve all flights
  x-api-slug: cargogetrouteorigindestinationfromdateproductcode-get
  description: Retrieve a list of all possible flights (both direct and connecting)
    between two airports on a given date. Routes are available for today and up to
