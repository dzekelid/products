...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/google-doubleclick/apis.md
...
- name: Google Doubleclick Merged API - Get Product
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/google-doubleclick/productsproductid-get-openapi.md
- name: Google Doubleclick Merged API - Get Product
  x-api-slug: productsproductid-get
  description: Gets the requested product by id.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-double-click.png
