...
- name: Akamai API List Usage per Contract
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/akamai/billing-center-api-v2-contracts-contractid-products-productid-measures-get.md
x-common:
- type: x-base
