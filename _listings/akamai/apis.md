...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/products/master/_listings/akamai/billing-center-api-v2-contracts-contractid-products-productid-measures-year,month,fromyear,frommonth,toyear,tomonth,statisticname,billingdayonly-get.md
x-common:
- type: x-base
